...
if ($environment eq "DEV")
{
    ...
    $CGI_TEMP_UPLOAD_DIR  = "/var/www/html/public_html/campaign/tmp";
    $DATA_BKUP            = "/var/www/html/public_html/campaign/data_bkup";
    $PATH_DYNAMIC_CONTENT = "/var/www/html/public_html/campaign";
    $PATH_DYNAMIC_TXT     = $PATH_DYNAMIC_CONTENT;
    $PATH_DYNAMIC_GEN     = $PATH_DYNAMIC_CONTENT . "/gen";
    $PATH_DYNAMIC_REP     = $PATH_DYNAMIC_CONTENT . "/rep";
    $RELATIVE_DYNAMIC_REP = "/campaign/rep";        
    $PATH_DYNAMIC_TMP     = $PATH_DYNAMIC_CONTENT . "/tmp";
    $RELATIVE_DYNAMIC_TMP = "/campaign/tmp";
    $PATH_DYNAMIC_FRONT   = $PATH_DYNAMIC_CONTENT;
    $RELATIVE_DYNAMIC_FRONT = "/campaign";            
    $PATH_DYNAMIC_MAP     = $PATH_DYNAMIC_CONTENT;
    $RELATIVE_DYNAMIC_MAP = "/campaign";                
    $PATH_DYNAMIC_DATA    = $PATH_DYNAMIC_CONTENT;
...
else
{
    ...
    $PATH_DYNAMIC_GEN     = $PATH_TO_WEBROOT . "/gen";
    $PATH_DYNAMIC_REP     = $PATH_TO_WEBROOT . "/rep";
    $RELATIVE_DYNAMIC_REP = "/rep";    
    $PATH_DYNAMIC_TMP     = $CGI_BIN_PATH . "/tmp";
    $RELATIVE_DYNAMIC_TMP = "/tmp";    
    $PATH_DYNAMIC_FRONT   = $PATH_TO_WEBROOT . "/campaign";
    $RELATIVE_DYNAMIC_FRONT = "/campaign";        
    $PATH_DYNAMIC_MAP     = $PATH_DYNAMIC_CONTENT;
    $RELATIVE_DYNAMIC_MAP = "";                    
    $PATH_DYNAMIC_DATA    = $CGI_BIN_PATH;
    $MAX_UPLOAD_SIZE      = 200000; # bytes
    $CJPEG_PROG           = "/usr/bin/cjpeg";           
    $CJPEG_FLAGS          = "-quality 70 -progressive";
...
if ($MAP_NAME_LONG eq "Bessarabia. 1941"){
    ...
    $GEOGRAFIC_COORDINATES= $PATH_DYNAMIC_CONTENT . "/BES41_geo_obj.data";
    $FRONT_LINE= $PATH_DYNAMIC_CONTENT . "/BES41_frontline.mis";
    $RED_OBJ_FILE= $PATH_DYNAMIC_CONTENT . "/BES41_red_obj.mis";
    $BLUE_OBJ_FILE= $PATH_DYNAMIC_CONTENT . "/BES41_blue_obj.mis";
    $CITY_PLACES= $PATH_DYNAMIC_CONTENT . "/BES41_city.mis";
    $TANKS_WP= $PATH_DYNAMIC_CONTENT . "/BES41_tank_wp.mis";  
    $FRONT_IMAGE= $PATH_DYNAMIC_CONTENT . "/BES41.bmp";
    $IMAP_DATA= $PATH_DYNAMIC_CONTENT . "/BES41_imap.data";

    $MAP_CODE="BES41";
    $MAP_NAME_LOAD="Bessarabia/load.ini";
    $FLIGHTS_DEF= $PATH_DYNAMIC_CONTENT . "/BES41_aircrafts.data";  
    @VVS_SUM_PLANES=("Li-2");
    $VVS_TRP_SPEED=270; # average speed for human VVS suply plane
